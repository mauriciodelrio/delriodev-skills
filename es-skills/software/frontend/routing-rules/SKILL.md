...
name: routing-rules
description: >
  Usa esta skill cuando implementes routing en Next.js App Router: layouts
  anidados, route groups, parallel routes, intercepting routes, guards de
  autenticación, redirects, search params tipados, y breadcrumbs.
---
