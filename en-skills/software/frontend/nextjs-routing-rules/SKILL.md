...
description: >
  Use this skill when implementing routing in Next.js App Router:
  nested layouts, route groups, parallel routes, intercepting routes,
  authentication guards, typed search params, redirects and rewrites.
---

# Routing Next.js App Router — Rules and Patterns
...
- `nextjs-project-structure` — route and layout organization in App Router
- `security-rules` — authentication guards, httpOnly tokens
- `error-handling-rules` — error.tsx, global-error.tsx in App Router
